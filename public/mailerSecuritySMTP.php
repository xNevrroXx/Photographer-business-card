...
$mail->Username = 'value'; // Ваш логин от почты с которой будут отправляться письма
$mail->Password = 'value'; // Ваш пароль от почты с которой будут отправляться письма
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465; // TCP port to connect to / этот порт может отличаться у других провайдеров

$mail->setFrom('value', adopt($project_name)); // от кого будет уходить письмо?
$mail->addAddress('value');     // Кому будет уходить письмо
